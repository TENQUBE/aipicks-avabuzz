...
const AppScreen: React.FC<AppScreenProps> = ({
  ...
  const modalPresentationStyle =
    globalOptions.theme === 'cupertino' ? CUPERTINO_ONLY_modalPresentationStyle : undefined
  const activityEnterStyle =
    globalOptions.theme === 'android' ? ANDROID_ONLY_activityEnterStyle : undefined
  ...
  useStyleEffectOffset({
    refs:
      globalOptions.theme === 'cupertino' || activityEnterStyle === 'slideInLeft'
        ? [paperRef]
        : [paperRef, appBarRef],
  ...
  return (
    ...
    >
      <div
        ...
        style={assignInlineVars(
          compactMap({
            ...
            [globalVars.appBar.heightTransitionDuration]: appBar?.heightTransitionDuration,
      ...
      >
        {activityEnterStyle !== 'slideInLeft' && <div className={css.dim} ref={dimRef} />}
        {appBar && (
          <AppBar
            {...appBar}
            ref={appBarRef}
        ...
        {!activity?.isRoot && globalOptions.theme === 'cupertino' && !swipeBackPrevented && (
